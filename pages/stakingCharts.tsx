...
function App() {
  ...
  useEffect(() => {
    const getNominations = async () => {
      ...
      // TODO fix typing
      // @ts-ignore
      setOperatorsToHighlight(nominations.toJSON()?.targets);
    };
    getNominations();
  ...
  //       console.log('Active Era', eraInfo.unwrap().index.toNumber(), 'start time', new Date(eraInfo.unwrap().start.unwrap().toNumber()));
  //     });
  ...
  //       console.log('Current Era', current.unwrap().toNumber());
  //     });
  ...
  return (
    <div className='App'>
      ...
      <ErasOperatorsTotalStakedChart highlight={operatorsToHighlight} />
